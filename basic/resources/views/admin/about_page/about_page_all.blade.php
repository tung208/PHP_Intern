                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post" action="{{route('update.aboutPage')}}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                       ...
                                       {{-- <input name="video_url" class="form-control" type="text" value="{{$aboutPage-> short_description}}"
                                               id="video_url">--}}
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        {{--<input name="home_slide" class="form-control" type="file"
                                               id="image" value="{{$aboutPage-> long_description}}">--}}
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="about_image" class="form-control" type="file"
                                               id="image" value="{{$aboutPage-> about_image}}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <img class="rounded-circle avatar-xl" id="showImage" src="{{(!empty($aboutPage-> about_image))? url($aboutPage-> about_image):
