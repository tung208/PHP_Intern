                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="profile_image" class="form-control" type="file"
                                               id="image" value="{{$editData-> profile_image}}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded-circle avatar-xl" src="{{(!empty($editData-> profile_image))? url('upload/admin_images/'.$editData-> profile_image):
